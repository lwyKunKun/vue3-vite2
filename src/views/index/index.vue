  ...
  <div class="index-conntainer">
    <div class="head-card">
      ...
      <div class="head-card-content">
        <h2 class="title">
          {{ sayHi }}! Vue3-Admin, {{ t('indexPage.descTitle') }}
        </h2>
        <p class="desc">
          vue3-admin 是基于 vue3 + vite2 + Element-Plus + Vue-Router4.x +
          Vuex4.x + Javascript开发的中后台管理平台，开箱即用！赶快试试吧...
        </p>
      </div>
    </div>
    <div class="content">
          ...
          <el-card class="card" shadow="hover">
            ...
            <el-descriptions class="margin-top" :column="3" :size="size" border>
              <el-descriptions-item
                v-for="(value, key) in packpage.dependencies"
                :key="key"
              >
                <template #label>
                  {{ key }}
